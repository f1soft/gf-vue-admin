...
// arModel is a active record design model for table authorities operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of authorities.
	Table = "authorities"
	// Model is the model object of authorities.
