...
// arModel is a active record design model for table jwt_blacklists operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of jwt_blacklists.
	Table = "jwt_blacklists"
	// Model is the model object of jwt_blacklists.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table jwt_blacklists.
	Columns = struct {
		Id         string //   
        CreatedAt  string //   
        UpdatedAt  string //   
