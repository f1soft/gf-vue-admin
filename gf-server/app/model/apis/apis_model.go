...
// arModel is a active record design model for table apis operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of apis.
	Table = "apis"
	// Model is the model object of apis.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table apis.
	Columns = struct {
		Id           string // 自增ID       
