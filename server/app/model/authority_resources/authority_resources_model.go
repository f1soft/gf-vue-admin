...
// arModel is a active record design model for table authority_resources operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of authority_resources.
	Table = "authority_resources"
	// Model is the model object of authority_resources.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table authority_resources.
	Columns = struct {
