...
// arModel is a active record design model for table authority_menu operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of authority_menu.
	Table = "authority_menu"
	// Model is the model object of authority_menu.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table authority_menu.
	Columns = struct {
