...
// arModel is a active record design model for table dictionaries operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of dictionaries.
	Table = "dictionaries"
	// Model is the model object of dictionaries.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table dictionaries.
	Columns = struct {
		Id         string // 自增ID        
