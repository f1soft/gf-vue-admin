...
// arModel is a active record design model for table jwts operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of jwts.
	Table = "jwts"
	// Model is the model object of jwts.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table jwts.
	Columns = struct {
		Id        string // 自增ID    
